<template>
  ...
  <aside
    class="flex flex-col border-r border-(--border) bg-(--surface) fixed top-0 left-0 z-40 transition-all duration-200"
    :class="[
      collapsed ? 'w-16' : 'w-60',
  ...
  >
    <!-- Logo -->
    <div class="h-16 flex items-center px-4 border-b border-(--border) gap-3 shrink-0">
    ...
    <div class="flex-1 flex flex-col overflow-y-auto min-h-0">
      ...
      <!-- Bottom -->
      <div class="px-2 py-4 border-t border-(--border) flex flex-col gap-1 shrink-0">
        <NuxtLink
